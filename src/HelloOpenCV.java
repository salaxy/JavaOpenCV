...
class DetectFaceDemo {
	public void run() {
		...
		try {
			...
			faceDetector = new CascadeClassifier(new File(getClass().getResource(
					"/haarcascade_frontalface_alt.xml").toURI()).getAbsolutePath());

			Mat image = Highgui.imread(new File(getClass().getResource("/lena.png").toURI())
					.getAbsolutePath());
